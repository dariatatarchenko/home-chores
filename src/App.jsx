...
function MainApp({household, me:initialMe, email, onSignOut}){
  ...
  useEffect(()=>{
    if(zoneExpandId){
      ...
      const focusRaf=requestAnimationFrame(()=>{ zoneNameInputRef.current?.focus(); });
  ...
  return (
    <div style={{height:"100%",background:"#08080f",display:"flex",justifyContent:"center",alignItems:"stretch",fontFamily:"'SF Pro Text',-apple-system,system-ui,sans-serif",overflow:"hidden"}}>
      ...
      <div style={{width:"100%",maxWidth:480,overflow:"hidden",display:"flex",flexDirection:"column",height:"100%",position:"relative",background:tc.bg}}>
        ...
        <div style={{flex:1,overflow:"hidden",position:"relative",display:"flex",flexDirection:"column"}}>
          ...
          {tab==="week"&&(
            <div style={{display:"flex",flexDirection:"column",height:"100%"}}>
              ...
              <div style={{flexShrink:0,margin:"0"}}>
                <div ref={stripRef} onScroll={e=>{weekScrollLeftRef.current=e.currentTarget.scrollLeft;}} style={{display:"flex",gap:4,paddingLeft:20,paddingRight:20,paddingTop:8,paddingBottom:20,overflowX:"auto",WebkitOverflowScrolling:"touch",msOverflowStyle:"none",scrollbarWidth:"none",
              ...
              {dayAllTasks.length>0&&(
                <div style={{flexShrink:0,padding:`4px 16px ${SPACE_MD}px 16px`}}>
                  ...
                  <div style={{background:S(0.07),borderRadius:4,height:4,overflow:"hidden"}}>
                  ...
                  return (
                    <div key={t.id+"-"+selDay} ref={el=>{if(el)cardRefs.current[t.id]=el;}} draggable
                      ...
                      {(t.timesPerDay||1)>1?(
                        <button onClick={e=>{ if(isFuture) return; e.currentTarget.blur(); toggleDone(t.id,selDay); }} style={{
                          ...
                          <div style={{position:"absolute",inset:0,display:"flex",alignItems:"center",justifyContent:"center"}}>
                            {done
                              ?<div style={{width:12,height:12,backgroundColor:isDark?"#211c3d":"#fff",WebkitMaskImage:"url(/icons/check.svg)",maskImage:"url(/icons/check.svg)",WebkitMaskSize:"contain",maskSize:"contain",WebkitMaskRepeat:"no-repeat",maskRepeat:"no-repeat",WebkitMaskPosition:"center",maskPosition:"center",animation:"checkPop 0.35s ease"}}/>
                              :isFuture
                              ?<div style={{width:12,height:12,backgroundColor:C(0.35),WebkitMaskImage:"url(/icons/lock-outline.svg)",maskImage:"url(/icons/lock-outline.svg)",WebkitMaskSize:"contain",maskSize:"contain",WebkitMaskRepeat:"no-repeat",maskRepeat:"no-repeat",WebkitMaskPosition:"center",maskPosition:"center"}}/>
                      ...
                      <button onClick={e=>{ if(isFuture) return; e.currentTarget.blur(); toggleDone(t.id,selDay); }} style={{
                        ...
                        {done&&<div style={{width:12,height:12,backgroundColor:isDark?"#211c3d":"#fff",WebkitMaskImage:"url(/icons/check.svg)",maskImage:"url(/icons/check.svg)",WebkitMaskSize:"contain",maskSize:"contain",WebkitMaskRepeat:"no-repeat",maskRepeat:"no-repeat",WebkitMaskPosition:"center",maskPosition:"center",animation:"checkPop 0.35s ease"}}/>}
                        {!done&&isFuture&&<div style={{width:12,height:12,backgroundColor:C(0.35),WebkitMaskImage:"url(/icons/lock-outline.svg)",maskImage:"url(/icons/lock-outline.svg)",WebkitMaskSize:"contain",maskSize:"contain",WebkitMaskRepeat:"no-repeat",maskRepeat:"no-repeat",WebkitMaskPosition:"center",maskPosition:"center"}}/>}
                      </button>
                      )}
                      {/* Text */}
                      <div style={{flex:1,minWidth:0,opacity:done?.4:1,transition:"opacity 0.2s"}}>
                        ...
                        <div style={{display:"flex",justifyContent:"flex-start",width:"fit-content",maxWidth:"100%",gap:6,marginTop:4,alignItems:"center",flexWrap:"nowrap",overflow:"hidden"}}>
                          ...
                          {streak>1&&<>
                            <div style={{width:4,height:4,borderRadius:"50%",background:C(0.2),flexShrink:0}}/>
                            <span style={{fontSize:13,color:"#fbbf24",display:"flex",alignItems:"center",gap:2,whiteSpace:"nowrap",flexShrink:0}}><div style={{width:12,height:12,backgroundColor:"#fbbf24",WebkitMaskImage:"url(/icons/streak-fill.svg)",maskImage:"url(/icons/streak-fill.svg)",WebkitMaskSize:"contain",maskSize:"contain",WebkitMaskRepeat:"no-repeat",maskRepeat:"no-repeat",WebkitMaskPosition:"center",maskPosition:"center"}}/>{streak}</span>
                          </>}
                          {t.rescheduledFrom&&<>
                            <div style={{width:4,height:4,borderRadius:"50%",background:C(0.2),flexShrink:0}}/>
              ...
              <div style={{display:"flex",flexDirection:"column",height:"100%"}}>
                ...
                <div style={{display:"grid",gridTemplateColumns:"repeat(7,1fr)",gap:4,marginBottom:12}}>
                  {cells.map((d,i)=>{
                    ...
                    return (
                      <div key={dStr} onClick={()=>setSelDay(dStr)} style={{borderRadius:10,aspectRatio:"1",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",gap:4,cursor:"pointer",transition:"all 0.15s",
                ...
                <div>
                  ...
                  <div style={{display:"flex",flexWrap:"wrap",gap:8,alignItems:"center"}}>
                    <button onClick={()=>setForm(f=>({...f,personIds:(f.personIds||[]).length===people.length?[meId]:people.map(p=>p.id)}))} style={{
                      ...
                      <span style={{color:(form.personIds||[]).length===people.length?C(0.9):TEXT2,fontSize:14,fontWeight:(form.personIds||[]).length===people.length?700:400}}>{tr("all")}</span>
                    </button>
                    {people.map(p=>{
                      ...
                      return <button key={p.id} onClick={()=>setForm(f=>{
                        ...
                        <span style={{color:sel?p.color:TEXT2,fontSize:14,fontWeight:sel?700:400}}>{p.name}</span>
                      </button>;
                    })}
                  </div>
                </div>
          ...
          {tab==="tasks"&&(
            <div style={{display:"flex",flexDirection:"column",height:"100%"}}>
              ...
              <div style={{display:"flex",alignItems:"flex-start",justifyContent:"space-between",marginBottom:14,minHeight:40}}>
                ...
                <div style={{display:"flex",alignItems:"center",gap:12}}>
                  <button
                    onTouchStart={e=>{e.preventDefault();pressStart("managezones",setPressedAddZone,true);}} onTouchEnd={e=>{e.preventDefault();setShowManageZones(true);pressEnd("managezones",setPressedAddZone,false);}} onTouchCancel={()=>pressEnd("managezones",setPressedAddZone,false)}
                    onMouseDown={()=>pressStart("managezones",setPressedAddZone,true)} onMouseUp={()=>{setShowManageZones(true);pressEnd("managezones",setPressedAddZone,false);}} onMouseLeave={()=>pressEnd("managezones",setPressedAddZone,false)}
                      ...
                      return (
                        <div key={t.id} style={{...CARD,cursor:"pointer",overflow:"hidden",boxSizing:"border-box"}} onClick={()=>setExpandId(open?null:t.id)}>
                          <div style={{display:"flex",alignItems:"center",gap:10,minHeight:44}}>
                            {pIds.length===1?(
                              <Avatar person={getPerson(pIds[0])} size={24}/>
                            ):(
                            ...
                            <div style={{flex:1,minWidth:0}}>
                              ...
                              <div style={{display:"flex",justifyContent:"flex-start",width:"fit-content",maxWidth:"100%",gap:6,marginTop:4,alignItems:"center",flexWrap:"nowrap",overflow:"hidden"}}>
                                ...
                                {people.length>1&&(()=>{
                                  if(pIds.length===people.length) return <><div style={{width:4,height:4,borderRadius:"50%",background:C(0.2),flexShrink:0}}/><span style={{fontSize:13,color:"#cbd5e1",fontWeight:600,whiteSpace:"nowrap",flexShrink:0}}>{tr("all")}</span></>;
                                  const p=getPerson(pIds[0]);
                            ...
                            <div onClick={e=>e.stopPropagation()} style={{marginTop:6,paddingTop:8}}>
                              ...
                              <div style={{display:"flex",flexWrap:"wrap",gap:8,marginBottom:14}}>
                                <button
                                  ...
                                  <span style={{color:(t.personIds||[t.personId]).filter(Boolean).length===people.length?C(0.9):TEXT2,fontSize:14,fontWeight:(t.personIds||[t.personId]).filter(Boolean).length===people.length?700:400,display:"inline-block",transform:pressedAccPerson==="all"?"scale(1.08)":"scale(1)",transition:pressedAccPerson==="all"?"transform 0.1s ease-out":"transform 0.4s cubic-bezier(0.34,1.56,0.64,1)"}}>{tr("all")}</span>
                                </button>
                                {people.map(p=>{
                                  const pIds=t.personIds||[t.personId].filter(Boolean);
          ...
          {tab==="settings"&&(
            <div style={{display:"flex",flexDirection:"column",height:"100%"}}>
              ...
              <div style={{flexShrink:0,padding:"16px 16px 16px",display:"flex",alignItems:"flex-start",justifyContent:"space-between",minHeight:40,gap:10}}>
                ...
                {myStreak>0&&(
                  <div style={{textAlign:"right",flexShrink:0}}>
                    <div style={{color:"#fbbf24",fontSize:16,fontWeight:700,whiteSpace:"nowrap",display:"flex",alignItems:"center",gap:6,justifyContent:"flex-end"}}><div style={{width:16,height:16,backgroundColor:"#fbbf24",WebkitMaskImage:"url(/icons/streak-fill.svg)",maskImage:"url(/icons/streak-fill.svg)",WebkitMaskSize:"contain",maskSize:"contain",WebkitMaskRepeat:"no-repeat",maskRepeat:"no-repeat",WebkitMaskPosition:"center",maskPosition:"center"}}/>{myStreak}-day streak!</div>
                    <div style={{color:C(0.35),fontSize:14,marginTop:2,whiteSpace:"nowrap"}}>Keep it up, {me?.name}!</div>
                  </div>
                )}
              </div>
              ):(
              ...
              {/* People */}
              <div style={{display:"flex",flexDirection:"column",gap:8}}>
                  {[...people].sort((a,b)=>(a.id===meId?-1:0)-(b.id===meId?-1:0)).map(p=>{
          ...
          <div style={{position:"absolute",inset:0,zIndex:300,background:THEME_COLORS[theme].bg,display:"flex",flexDirection:"column",transform:`translateX(${statsVisible?0:100}%)`,transition:"transform 0.32s cubic-bezier(0.32,0.72,0,1)"}}>
              ...
              {(()=>{
                ...
                return(<>
                  ...
                  <div style={{...CARD,marginBottom:12}}>
                    {SL("This Week")}
                    {mvp&&<div style={{background:"rgba(251,191,36,0.12)",borderRadius:14,padding:"8px 16px",marginBottom:20,display:"flex",alignItems:"center",gap:8,border:"1px solid rgba(251,191,36,0.3)"}}>
                      <span style={{fontSize:20}}>⭐</span>
                      <span style={{color:"#fbbf24",fontSize:13,fontWeight:500}}>Top performer this week: {mvp.name}</span>
                    </div>}
                    {dreamTeam&&<div style={{background:"rgba(52,211,153,0.12)",borderRadius:14,padding:"8px 16px",marginBottom:20,display:"flex",alignItems:"center",gap:8,border:"1px solid rgba(52,211,153,0.3)"}}>
                      <span style={{fontSize:20}}>🤝</span>
                          ...
                          <div style={{display:"flex",alignItems:"center",gap:10,marginBottom:6}}>
                            ...
                            <div style={{flex:1}}>
                              <div style={{color:"rgba(255,255,255,0.88)",fontSize:14,fontWeight:600,display:"flex",alignItems:"center",gap:6}}>
                                {p.name}
                                {meId===p.id&&<span style={{fontSize:11,color:ACCENT,background:"rgba(129,140,248,0.15)",borderRadius:4,padding:"4px 6px"}}>me</span>}
                              </div>
                    ...
                    {people.map(p=>{
                      ...
                      return(
                        <div key={p.id} style={{marginBottom:pi<people.length-1?24:0}}>
                          ...
                          {next?(
                            <div style={{color:C(0.5),fontSize:12,marginTop:2}}>
                              {next.days-pStreak} more days to unlock {next.label}
                            </div>
                          ):(
                            <div style={{color:"#e879f9",fontSize:12,marginTop:2}}>All streak badges unlocked!</div>
                          )}
                        </div>
                      );
                    })}
                              ...
                              {achs.map(a=>(
                                <div key={a.zone} style={{
                                  ...
                                  {(()=>{
                                    ...
                                    return(
                                      <div style={{background:"rgba(255,255,255,0.07)",borderRadius:4,height:4,overflow:"hidden"}}>
                                        <div style={{height:"100%",width:`${pct}%`,borderRadius:4,background:a.ach.color}}/>
                                      </div>
                                    );
                                  })()}
                                </div>
        ...
        {showManageZones&&(
          <div style={{position:"absolute",inset:0,zIndex:290,background:THEME_COLORS[theme].bg,display:"flex",flexDirection:"column"}}>
              <div style={{flexShrink:0,padding:"16px 16px 16px",display:"flex",alignItems:"center",minHeight:40,gap:8}}>
          ...
          <div style={{position:"absolute",inset:0,background:"rgba(10,10,14,0.92)",display:"flex",alignItems:"center",justifyContent:"center",zIndex:350}} onClick={()=>setEmojiPicker(false)}>
            <div onClick={e=>e.stopPropagation()} style={{width:328,background:isDark?"#2a2a32":"#ffffff",border:"none",borderRadius:20,padding:16,boxShadow:"0 20px 60px rgba(0,0,0,0.6)"}}>
              ...
              <div style={{display:"grid",gridTemplateColumns:"repeat(6,44px)",justifyContent:"space-between",gap:2}}>
                {ZONE_ICONS.map(e=><button key={e} onClick={()=>{setZForm(f=>({...f,emoji:e}));setEmojiPicker(false);}} style={{background:zForm.emoji===e?"rgba(129,140,248,0.2)":"transparent",border:zForm.emoji===e?`1px solid ${ACCENT}`:"1px solid transparent",borderRadius:10,width:44,height:44,boxSizing:"border-box",cursor:"pointer",display:"flex",alignItems:"center",justifyContent:"center",padding:0}}><div style={{width:24,height:24,backgroundColor:zForm.emoji===e?"#fff":C(0.6),WebkitMaskImage:`url(/icons/${e}.svg)`,maskImage:`url(/icons/${e}.svg)`,WebkitMaskSize:"contain",maskSize:"contain",WebkitMaskRepeat:"no-repeat",maskRepeat:"no-repeat",WebkitMaskPosition:"center",maskPosition:"center"}}/></button>)}
              </div>
            </div>
          </div>
        )}
